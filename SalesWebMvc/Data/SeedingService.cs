...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Vinicius", "vinicius@gmail.com", new DateTime(2001, 2, 01), 4000.0, d1);
            Seller s2 = new Seller(2, "Maria", "maria@gmail.com", new DateTime(1998, 5, 28), 2000.0, d3);
            Seller s3 = new Seller(3, "Gean", "gean@gmail.com", new DateTime(1999, 7, 22), 3000.0, d2);
            Seller s4 = new Seller(4, "Guilherme", "guilherme@gmail.com", new DateTime(1990, 9, 26), 3500.0, d4);
            Seller s5 = new Seller(5, "Alex", "alex@gmail.com", new DateTime(2002, 9, 21), 1500.0, d1);
            Seller s6 = new Seller(6, "Marcio", "marcio@gmail.com", new DateTime(1990, 9, 26), 4000.0, d4);
